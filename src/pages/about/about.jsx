...
import VisionMissionGoal from './vision-mission-goal.jsx';

class SafeAboutSection extends Component {
    ...
    componentDidCatch(error, errorInfo) {
        console.error('About section failed to render:', error, errorInfo);
    }
